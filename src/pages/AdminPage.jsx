        ...
        <div className="min-h-screen text-white bg-gray-900">
            ...
            <div class="max-w-sm mx-auto">
                ...
                <div class="mb-5">
                    ...
                    <input type="password" id="password" value={password} onChange={(e) => setPassword(e.target.value)} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 
