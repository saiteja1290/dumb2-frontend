...
const Past_contests = () => {
    return (
        <div className='min-h-screen text-white bg-gray-900'>
            ...
            <center>
                <Link to={`/contest_1`}>
                    <a href="#" class="inline-flex items-center justify-center p-3 text-base font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
